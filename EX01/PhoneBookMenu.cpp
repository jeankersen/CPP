...
void DisplayContact(PhoneBook &phone, int i)
{
    ...
    index = add_spaces(8) + std::to_string(i + 1) + "_";
    fname = add_spaces(10 - phone.Cons[i].get_fname_short().size()) + phone.Cons[i].get_fname_short();
    lname = add_spaces(10 - phone.Cons[i].get_lname_short().size()) + phone.Cons[i].get_lname_short();
    nname = add_spaces(10 - phone.Cons[i].get_nname_short().size()) + phone.Cons[i].get_nname_short();

...
/*   Updated: 2024/06/10 12:59:00 by jvillefr         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void test1()
{
    try 
    {
        ...
        PresidentialPardonForm PForm1(PForm2);
        ShrubberyCreationForm SForm1 = SForm2;
...
int main(void) 
{
    ...
    std::cout << COLOR_ORANGE <<  " TEST 1-default and arguments construtor forms with all forms" << COLOR_BACK << std::endl;
    test1();
